...
use App\Http\Controllers\Web\ExportStatusController;
...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/exports/{export}/status', ExportStatusController::class)->name('exports.status');
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/dashboard/export-pdf', AdminComplianceSnapshotPdfExportController::class)->name('dashboard.export_pdf');
    ...
    Route::post('/reports/checklist-instances/export-pdf', AdminCompletedChecklistsReportPdfExportController::class)
        ->name('reports.checklist_instances_pdf');

    Route::post('/reports/auditor-activity/export-pdf', AdminAuditorActivityPdfExportController::class)
        ->name('reports.auditor_activity_pdf');

    Route::post('/templates/{template}/export-pdf', AdminChecklistTemplatePdfExportController::class)
        ->name('templates.export_pdf');

    Route::post('/instances/{instance}/export-pdf', ChecklistInstancePdfExportController::class)
...
Route::middleware(['auth', 'role:auditor'])->prefix('auditor')->name('auditor.')->group(function () {
    ...
    Route::post('/dashboard/export-pdf', AuditorAuditorActivityPdfExportController::class)->name('dashboard.export_pdf');
